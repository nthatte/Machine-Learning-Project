...
In the section \ref{sec:RandFor} we discussed a method of using large number of features to learn a single random forest for semantic label segmentation. 
